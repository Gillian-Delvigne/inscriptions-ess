...
export class SignupComponent implements OnInit {
  ...
  onChange(value: any) {
    ...
    console.log(value, this.localEntities);
  }

  onChangeActivity(value: any) {
    /*console.log(value, this.activities);
    console.log(this.activities.find(x => x.type === value))*/
    this.activityList = this.activities.find(x => x.type === value).activity;
    // console.log(value, this.activities, 'h');
  }
